...
数据库初始化后，系统会创建以下测试账号（密码均为：`123456`）：

| 角色 | 用户名 | 姓名 | 编号 | 邮箱 |
| ---- | ------ | ---- | ---- | ---- |
| 管理员 | admin | 系统管理员 | - | admin@admin.com |
| 教师 | T202401 | 王建国 | T202401 | T202401@teacher.com |
| 教师 | T202402 | 李明华 | T202402 | T202402@teacher.com |
| 辅导员 | C202401 | 张晓红 | C202401 | C202401@counselor.com |
| 学生 | 23010001 | 张三 | 23010001 | 23010001@stu.com |
| 学生 | 23010002 | 李四 | 23010002 | 23010002@stu.com |
| 学生 | 23020001 | 王五 | 23020001 | 23020001@stu.com |

**编号规则说明：**

- **学号格式**：年级(2位) + 专业代码(2位) + 序号(4位)，如 `23010001` 表示23级01专业0001号
- **教师职工号格式**：T + 年份(4位) + 序号(2位)，如 `T202401` 表示2024年入职01号教师
- **辅导员职工号格式**：C + 年份(4位) + 序号(2位)，如 `C202401` 表示2024年入职01号辅导员
